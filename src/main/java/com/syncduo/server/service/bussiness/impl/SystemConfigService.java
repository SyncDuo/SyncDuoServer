...
import com.syncduo.server.configuration.ThreadPoolConfig;
...
public class SystemConfigService
    ...
    @Autowired
    public SystemConfigService(ThreadPoolConfig threadPoolConfig) {
    ...
    public SystemConfigEntity updateSystemConfig(SystemConfigEntity systemConfigEntity) throws SyncDuoException {
        ...
        // 更新 min/max threads num
        Integer handlerMinThreads = systemConfigEntity.getHandlerMinThreads();
        Integer handlerMaxThreads = systemConfigEntity.getHandlerMaxThreads();
        if (ObjectUtils.allNotNull(handlerMinThreads, handlerMaxThreads)) {
